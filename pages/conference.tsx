...
export default function Conference() {
  return (
    <Layout>
      ...
      <div className="max-w-screen-md px-8 pb-24 mx-auto">
        <h1 className="mb-3 text-6xl font-bold dark:text-nit-white">
          Natives in Tech Conf
        </h1>

        <p className="mb-6 text-lg prose prose-lg dark:text-nit-light-grey">
        ...
        <h2 className="mb-3 text-4xl font-bold dark:text-nit-white">
          Who is this conference for?
        </h2>

        <ul className="mb-6 text-lg prose prose-lg list-disc dark:text-nit-light-grey">
